...
declare module "http" {
    ...
    class ClientRequest extends OutgoingMessage {
         ...
         *   http.get('assignment11server-phi.vercel.app', { agent }, (res) => {
         *     res.on('data', (data) => {
         *       // Do nothing
         *     });
         *   });
         ...
         *   const req = http
         *     .get('assignment11server-phi.vercel.app', { agent }, (res) => {
         *       // ...
         *     })
         *     .on('error', (err) => {
    ...
    class IncomingMessage extends stream.Readable {
         ...
         * > new URL(request.url, `http://${request.headers.host}`)
         * URL {
         *   href: 'https://assignment11server-phi.vercel.app/status?name=ryan',
