...
const ManageMyPostsCard = ({ data, handleDelete }) => {
    const {_id,  position_title, deadline, category, thumbnail  } = data || {};
// console.log(object);
    return (
        <div className=' border border-slate-500 w-[300px] gap-5 rounded-xl'>
            <div className='flex flex-col justify-center items-center  '>
                <h1>Category: {category}</h1>
                <h1>Title: {position_title}</h1>
                <img className='h-[120px]' src={thumbnail} alt="" />
                <h2>DeadLine: {deadline}</h2>
            </div>
            <div className='flex items-center justify-center gap-x-6 border-4 border-red-600 w-52 m-auto mb-2 mt-3 rounded-xl'>
                ...
                <Link title="Update" to={`/update/${_id}`}>
...
export default ManageMyPostsCard;